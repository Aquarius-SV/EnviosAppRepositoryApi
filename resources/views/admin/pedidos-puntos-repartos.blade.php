              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @break  
                    @case(3)
                    <label class="badge badge-success">Pendiente de aceptacion</label>
                    @break 
                  ...
                  <td class="text-center">                                   
                    ...
                    @elseif($pedido->estado_detalle == 1)
                      <a  type="button" class="btn" data-toggle="modal"
                      data-target="#reasignarModal" onclick="Livewire.emit('assignPedido',@js($pedido))">
                        <i class="typcn typcn-edit mx-0 text-success" data-bs-toggle="tooltip" data-bs-placement="top"
