                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <h1 class="size-24" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #b8bdc9;font-size: 20px;line-height: 28px;text-align: left;" lang="x-size-24">
                                              <span style="text-decoration: inherit;color: #8690a8;">Segundo intento de entrega</span>
                                            </h1>
                                            <p class="size-17" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 17px;line-height: 26px;" lang="x-size-17">
                                              <span style="text-decoration: inherit;">No se ha podido hacer la entrega de tu paquete, debido a que no te encontrabas en tu domicilio por segunda ocasión. Puedes hacer retiro de tu paquete en nuestro centro de reparto.</span>
                                            </p>
                                        </div>
                                    </div>
