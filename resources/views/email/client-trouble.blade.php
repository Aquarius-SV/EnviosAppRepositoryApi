                        ...
                        <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);" id="emb-email-header-container">
                            ...
                            <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                                <div class="logo-center" align="center" id="emb-email-header">
                                  <img style="display: block;height: auto;width: 100%;border: 0;max-width: 141px;" src="{{ $message->embed('mails/images/aqlogo.png') }}" alt="" width="141" />
                                </div>
                            </div>
                            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                        </div>
                                ...
                                <div class="column" style="text-align: left;color: #595959;font-size: 14px;line-height: 21px;font-family: Lato,Tahoma,sans-serif;">
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <h1 class="size-24" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #b8bdc9;font-size: 20px;line-height: 28px;text-align: left;" lang="x-size-24">
                                              <span style="text-decoration: inherit;color: #8690a8;">Intento de entrega</span>
                                            </h1>
                                            <p class="size-17" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 17px;line-height: 26px;" lang="x-size-17">
                                              <span style="text-decoration: inherit;">No se ha podido hacer la entrega de tu paquete, debido a que no te encontrabas en tu domicilio. Agenda un nuevo intento de entrega haciendo click en el boton, el enlace o visita nuestro punto de reparto.</span>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: left;">
                                            <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #6b7489;font-family: Lato, Tahoma, sans-serif;" href="{{ route('agendar.cita', $pedido) }}">Agendar Reparto</a>
                                            <![endif]>
                                            <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://example.com" style="width:122.25pt" arcsize="9%" fillcolor="#6B7489" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0pt,8.25pt,0pt,8.25pt"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Lato,Tahoma,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:1.5px">Agendar Reparto</center></v:textbox></v:roundrect><![endif]-->
                                        </div>
                                        <a href="{{ route('agendar.cita', $pedido) }}">{{ route('agendar.cita', $pedido) }}</a>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <p class="size-17" style="Margin-top: 0;Margin-bottom: 0;font-size: 17px;line-height: 26px;" lang="x-size-17">Este es un mensaje auto generado,<br />
                                                por favor no respondas a el.</p>
                                            <p class="size-17" style="Margin-top: 20px;Margin-bottom: 0;font-size: 17px;line-height: 26px;" lang="x-size-17">Atentamente,<br />
                    ...
                    <div role="contentinfo">
                        ...
                        <div class="layout email-flexible-footer email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;" dir="rtl" id="footer-content">
                            <div class="layout__inner right-aligned-footer" style="border-collapse: collapse;display: table;width: 100%;">
                                ...
                                <div class="column" style="text-align: right;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Lato,Tahoma,sans-serif;" dir="ltr">
                                    <div class="footer-logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #7b663d;font-family: Roboto,Tahoma,sans-serif;" align="center">
                                        <div style="margin-left: 20px;" emb-flexible-footer-logo align="center">
                                          <img style="border: 0;display: block;height: auto;width: 100%;max-width: 141px;" src="{{ $message->embed('mails/images/aqlogo.png') }}" alt="" width="141" />
                                        </div>
                                    </div>
                                </div>
                                <!--[if (mso)|(IE)]></td><![endif]-->
                                ...
                                <table style="border-collapse: collapse;table-layout: fixed;display: inline-block;width: 439px;" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="column js-footer-additional-info" style="text-align: right;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Lato,Tahoma,sans-serif;width: 439px;" dir="ltr">
                                                    <div style="margin-left: 0;margin-right: 0;Margin-top: 10px;Margin-bottom: 10px;">
                                                        ...
                                                        <div class="email-footer__additional-info" style="font-size: 12px;line-height: 19px;margin-bottom: 15px;">
                                                            <span>
                                                                <preferences style="text-decoration: underline;" lang="es"><a href="http://aqpaqueteria.com/" target="_blank">{{ env('APP_NAME') }}</a></preferences>&nbsp;&nbsp;|&nbsp;&nbsp;
                                                            </span>
                                                            <unsubscribe style="text-decoration: underline;"><a href="https://aquariusit-sv.com/" target="_blank">AquariusIT</a></unsubscribe>
                                                        </div>
                                                        <!--[if mso]>&nbsp;<![endif]-->
                                                    </div>
                                                </div>
