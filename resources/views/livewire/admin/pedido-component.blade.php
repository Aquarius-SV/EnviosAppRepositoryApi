            ...
            <div class="modal-body">
              <form>
               ...
               {{--  <div class="mb-3">
                ...
                <hr>
                <h3 class="text-center text-black">Puntos de repartos</h3>    
                <hr> 
                <div class="row">
                  <div class="mb-3 col-6">
                    <label for="">Departamento <span class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                  <label for="">Puntos de reparto<span class="text-danger">*</span></label>
                  <select class="form-select @error('punto') is-invalid @enderror" aria-label="Selecione el punto" wire:model="punto">
                    <option style="display: none;">Selecione el punto</option>
                    @forelse ($puntos as $pt)
                    <option value="{{ $pt->id }}">Nombre:{{ $pt->nombre }}-Cod:{{ $pt->codigo }}</option>
                    @empty
                    <option>No hay datos disponibles</option>
                    @endforelse 
                  </select>
                ...
                <div class="row">
                 ...
                 {{--  <div class="mb-3 col-6">
                    <label for="">Zona de envío<span class="text-danger">*</span></label>
                    <select class="form-select @error('tipo_zona') is-invalid @enderror" aria-label="Seleciona una opción" wire:model="tipo_zona">
                      <option style="display: none;" selected>Seleciona una opción</option>
                      <option value="Local">Local</option>
                      <option value="Externa">Externa</option>                  
                    </select>
                    @error('tipo_zona') <span class="text-danger">{{ $message }}</span> @enderror
                  </div> --}}
                </div>    
                <div class="row">
                  <div class="mb-3 col-6">
